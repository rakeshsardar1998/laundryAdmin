...
export class ListComponent implements OnInit {
  COLS = [
    { ID: 'notificationTitle', TX: 'Notification Title' },
    { ID: 'notificationMessage', TX: 'Notification Message' },
    { ID: 'notificationType', TX: 'Notification Type' },
    { ID: 'notificationFor', TX: 'Notification For' },
    { ID: 'isRead', TX: 'IsRead' },
    // { ID: 'expiryDate', TX: 'Expiry Date' },
    // { ID: 'priority', TX: 'Priority' },
  ...
  fetchData(): void {
    ...
    this.MW.GET(ZXAPI.NOTIFICATION.LIST).subscribe(
      (response: any) => {
        ...
        this.DATA = new MatTableDataSource(response.data.data);
  ...
  ITEM(IT: any): void {
    this.SY.OPEN('notification/view', IT.notificationId);
  }

  getValue(columnId: string, element: any): string {
    console.log('columnId', columnId)
    if (columnId === 'isActive' || columnId === 'isDeleted' || columnId === 'isRead') {
  ...
  getColor(columnId: string, element: any): string {
    ...
    } else if (columnId === 'isActive' || columnId === 'isRead') {
